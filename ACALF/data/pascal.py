...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot, use_original_imgsize):
        ...
        # 按照类别得到图像名称 img_metadata_classwise[0, 1, 2, 3, 4]
    ...
    def __getitem__(self, idx):
        ...
        # print("query_ignore_idx", np.unique(query_ignore_idx.cpu().numpy()))
        # (5, 3, 384, 384)
        ...
        for scmask in support_cmasks:
            ...
            # print("support_ignore_idx", np.unique(support_ignore_idx.cpu().numpy()))
            support_masks.append(support_mask)
            support_ignore_idxs.append(support_ignore_idx)
        # (5, 384, 384)
        support_masks = torch.stack(support_masks)
        # 5, 384, 384 ignore_idx除了原来值为255的像素为1，其他所有像素值都为0
